...
void setup() {
  ...
  //  scale.set_scale();
  scale.tare_avg_blocking(10); // Reset the scale to 0; Reads value 10 times, calculates average and uses it as offset.

  //  long zero_factor = scale.read_avg_blocking(); //Get a baseline reading
  //  Serial.print("Zero factor: "); //This can be used to remove the need to tare_avg_blocking the scale. Useful in permanent scale projects.
